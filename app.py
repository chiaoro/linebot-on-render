...
if user_id in user_sessions:
    ...
    # Step 1：輸入原值班「日期 + 班別名稱」
        ...
        if match:
            ...
            session["step"] = 2
            prompt = "🔁 請輸入對調醫師與調換日期（例如：李大華 5/20）" if session["type"] == "值班調換" else "🙋‍♂️ 請輸入代理醫師姓名"
    ...
    # Step 3：輸入原因後送出
        ...
        webhook_url = "https://script.google.com/macros/s/你的_webhook_url/exec"  # 修改為你的網址
        payload = {
            "request_type": session["type"],
